...
$(DOCKER_PLATFORM_MONITOR)_RUN_OPT += -v /usr/local/bin/sc_fan:/usr/local/bin/sc_fan:ro
$(DOCKER_PLATFORM_MONITOR)_RUN_OPT += -v /usr/local/bin/sc_psu:/usr/local/bin/sc_psu:ro
